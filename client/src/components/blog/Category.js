...
import { searchCategory } from "../../actions/post";
...
const Category = ({
  match,
  searchCategory,
  post: { searchCategories, categoriesLoading },
}) => {
  useEffect(() => {
    searchCategory(match.params.category);
  }, [searchCategory]);
  return (
    <Fragment>
      <Breadcrumb title={match.params.category} />
      <section className="blog_area blog_padding">
        <div className="container">
          <div className="row">
            <div className="col-lg-8 mb-5 mb-lg-0">
              <div className="blog_left_sidebar">
                {categoriesLoading || searchCategories.length <= 0 ? (
                  <Spinner />
                ) : (
...
export default connect(mapStateToProps, { searchCategory })(Category);
